...
class EmailAuthPage extends StatefulWidget {
  ...
  @override
  _EmailAuthPageState createState() =>
      _EmailAuthPageState();
}

class _EmailAuthPageState
    extends State<EmailAuthPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(body:
       StoreObserver<UserStore>(builder: (UserStore userStore,BuildContext context) {
              if (_currpage == 0) {
                return Container(
